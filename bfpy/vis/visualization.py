...
def basis_func_plot(basis, wavelength_ind, crop=False):
    ...
    if crop: # TODO: get this working with MD / EQ basis
    ...
    elif basis.basis_parameters.wavelength_count > basis.basis_parameters.ux_count:
        plot_width = basis.basis_parameters.wavelength_count
    else:
        plot_width = basis.basis_parameters.ux_count
